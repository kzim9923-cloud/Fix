...
open class FocusApplication : LocaleAwareApplication(), LifecycleObserver {
    ...
    private fun enableStrictMode() {
        ...
        // Never show StrictMode dialogs in the debug APK. On modern Android versions
        // these dialogs can be triggered by framework/library I/O during startup and
        // make the app appear to hang. Keep StrictMode diagnostics in logcat instead.
        // Espresso also uses penaltyLog(), so both normal debug and test processes
        // behave consistently without a blocking UI dialog.
